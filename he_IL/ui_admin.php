<?php
	...
	'page_not_found_message' => 'צר לנו, הדף אותו חיפשת איננו קיים.  <p><strong>האם עקבת אחרי הלינק ממקום אחר כלשהו באתר?</strong><br /> אם הגעת לעמוד זה מחלק אחר באתר, אנא <a href="#">צור קשר</a> איתנו על מנת שנוכל לתקן את טעותנו.</p><p><strong> האם הגעת לכאן מקישור המופיע באתר אחר?  </strong><br /> קישורים מאתרים חיצוניים יכולים לפעמים להיות מיושנים או בעלי שגיאת כתיב.  <a href="#">ספר לנו</a> מהיכן הגעת וננסה ליצור קשר עם האתר האחר על מנת לתקן את הבעיה.</p><p><strong>האם הקלדת את הקישור? </strong><br />ייתרן והקלדת את הכתובת באופן שגוי. אנא וודא שכתבת את הכתובת הנכונה, שמרת על אותיות גדולות וקטנות כשורה וכן הלאה... </p>',
	...
	'password_reset_subject' => 'איתחול סיסמת הושאידי',
	'phone' => 'טלפון',
...
',
	...
	'upgrade_ushahidi' => 'שדרג את הושאידי',
	'upgrade_ushahidi_status' => 'סטטוס שידרוג הושאידי',
