...
',
	...
	'settings_share_site_stats' => 'סטטיסטיקת כניסות מאוחסנים בשרת אשר נשלט על ידי הושאידי (Ushahidi). על ידי הפעלת אפשרות זו, תזכה בגישה לסטטיסטיקת כניסות ישירות בפאנל הניהול שלך. על ידי ביטול אופציה זו, יופסק איסוף נתונים סטטיסטיים על הגולשים ותמנע ממך האפשרות לשחזר את נתוני התנועה לאתר בזמן שהאופציה הייתה כבויה.',
