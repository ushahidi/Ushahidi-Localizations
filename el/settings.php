...
// PO revision date:  2013-02-03 21:01+0000
$lang = array(
	...
	'banner_image' => array(
		'default' => 'Κάτι δεν πήγε καλά με τη μεταφόρτωση της εικόνας για το banner σου',
		'size' => 'Το μέγεθος του banner σου υπερβαίνει το όριο για αυτή τη μεταφόρτωση.',
	) ,
	'cache_pages' => array(
	...
	'sms' => array(
		...
		'flsms_description' => 'Το FronlineSMS είναι ένα λογισμικό ανοιχτού κώδικα, το οποίο μετατρέπει ένα λάπτοπ και ένα κινητό τηλέφωνο σε ένα κέντρο επικοινωνίας. Όταν εγκατασταθεί, το πρόγραμμα επιτρέπει στους χρήστες να στέλνουν και να λαμβάνουν μηνύματα κειμένου σε μεγάλες ομάδες ανθρώπων μέσω κινητού τηλεφώνου. Κάνε κλικ στο γκρι κουτί για να κατεβάσεις το πρόγραμμα από το FrontlineSMS.com',
		'flsms_download' => 'Κατέβασε το FronlineSMS και εγκατέστησέ το στον υπολογιστή σου.',
		'flsms_instructions' => 'Τα μηνύματα που λαμβάνονται από το κέντρο επικοινωνίας FrontlineSMS μπορούν να συγχρονίζονται με το Ushahidi. Λεπτομερείς σχετικές οδηγίες μπορείς να βρεις <strong><a href="http://wiki.ushahidi.com/display/WIKI/How+to+Set-up+FrontlineSMS+and+Ushahidi" target="_blank">εδώ</a></strong>. Θα χρειαστείς το παρακάτω κλειδί και το link για να στήσεις το συγχρονισμό με το FrontlineSMS.',
		'flsms_key' => 'Το κλειδί συγχρονισμού του Ushahidi.',
		'flsms_link' => 'FrontlineSMS HTTP Post LINK',
		'flsms_synchronize' => 'Συγχρονισμός με το Ushahidi',
