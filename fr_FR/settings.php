...
// PO revision date:  2012-11-02 14:49+0000
$lang = array(
	...
	'allow_alerts' => array(
		'between' => 'Le champ d\\\'admission alertes ne semble pas contenir une valeur valide.',
		'required' => 'Le champ d\\\'admission des alertes est nécessaire.',
	) ,
	'allow_reports' => array(
	...
	'api' => array(
		'default_record_limit' => 'Nombre par défaut d\\\'enregistrement à extraire par requête API',
		'maximum_record_limit' => 'Nombre maximum d\\\'enregistrements à extraire par requête API',
		'maximum_requests_per_ip_address' => 'Nombre maximum de requêtes de l\\\'API par dresse IP',
	) ,
	'api_akismet' => array(
		'alpha_numeric' => 'Le champ Akismet ne semble pas contenir une valeur valide.',
		'length' => 'Le champ Akismet ne semble pas contenir une valeur valide.',
	) ,
	'banner_image' => array(
		'default' => 'Problème de téléchargement de votre image de bannière.',
		'size' => 'La taille de votre bannière dépasse la limite autorisée de téléchargement.',
	) ,
	'cache_pages' => array(
	...
	'sms' => array(
		...
		'flsms_description' => 'FrontlineSMS est un logiciel libre open source qui transforme un ordinateur portable et un téléphone mobile en centrale de communication. Une fois installé, le programme permet aux utilisateurs d\\\'envoyer et de recevoir des messages texte avec de grands groupes de personnes par téléphones mobiles. Cliquez sur la case grise pour télécharger l\\\'application via FrontlineSMS.com',
		'flsms_download' => 'Téléchargez Frontline SMS et installez-le sur votre ordinateur',
		'flsms_instructions' => 'Les messages reçus par la plateforme FrontlineSMS peut être synchronisés avec Ushahidi. Des instructions détaillées sur la façon de synchroniser la plateforme peuvent être trouvées <strong><a href="http://wiki.ushahidi.com/display/WIKI/How+to+Set-up+FrontlineSMS+and+Ushahidi" target="_blank">ici</a></strong>. Vous aurez besoin de la clé et du lien ci-dessous pour configurer la synchronisation avec FrontlineSMS',
		'flsms_key' => 'Votre clé de Synchronisation Ushahidi',
		'flsms_link' => 'Lien HTTP du post FrontlineSMS',
		'flsms_synchronize' => 'Sync avec Ushahidi',
