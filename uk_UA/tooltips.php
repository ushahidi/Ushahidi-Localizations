...
// PO revision date:  2014-03-12 19:06+0000
$lang = array(
	'actions' => array(
	...
	'feed_geolocation_user' => 'Якщо ви хочете визначити геоприв\'язку записів стрічок, виберіть користувача http://geonames.org, увімкніть вільні веб-сервіси і введіть тут. Залиште порожнім, щоб вимкнути цю функцію. <br /> <br /> Використовуйте з помірністю!',
);
