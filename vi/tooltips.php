...
$lang = array(
	...
	'settings_allow_feed_category' => 'Điều này cho phép tạo hạng mục mới từ những nguồn cung cấp tin tức cập nhật kiểu RSS',
	...
	'feed_geolocation_user' => 'Nếu bạn muốn định danh tọa độ của những đầu mục cung cấp dữ liệu, hãy lấy một người dùng tại http://geonames.org, cho phép các dịch vụ web miễn phí và nhập nó vào đây. Hãy để trống để vô hiệu hóa chức năng này. <br /> <br /> Cẩn thận với các mức giới hạn sử dụng ! ',
);
