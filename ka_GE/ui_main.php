<?php
	...
	'alerts_enter_mobile' => 'შეიყვანეთ მობილურის ნომერი ქვეყნის კოდის მითითებით',
	'alerts_get' => 'შეტყობინების მიღება',
	'alerts_mobile_phone' => 'მობილური ტელეფონი:',
	'alerts_place_spot' => 'ან ქვემოთ განათავსეთ ნიშანი რუქაზე  და 20 კილომეტრის ფარგლებში ანგარიში წარდგენის შემთხვევაში ჩვენ გამოგიგზავნით შეტყობინებას .',
	'alerts_place_spot2' => 'თუ თქვენ ვერ იპოვეთ თქვენი ადგილმდებარეობა, სწორი მდებარეობის მოსანიშნად დააწკაპუნეთ რუქაზე  .',
	...
	'alerts_step2_send_alerts' => '<strong>ნაბიჯი 2:</strong> შეტყობინება გამოაგზავნეთ ჩემს:',
	'alerts_step3_select_catgories' => '<strong>ნაბიჯი 3 (Optional):</strong> აირჩიეთ კატეგორიები',
	'alert_confirm_previous' => 'დაადასტურეთ წინა შეტყობინების მოთხოვნა',
	...
	'comment_rating' => 'კომენტარები რეიტინგი',
	...
	'contact_email' => 'თქვენი ელექტრონული ფოსტის მისამართო',
	'contact_message' => 'მესიჯი',
	'contact_message_has_send' => 'თქვენი მესიჯი გაგსავნილია!',
	'contact_name' => 'თქვენი სახელი',
	'contact_phone' => 'თქვენი ტელეფონის ნომერი',
	'contact_send' => 'მესიჯის გაგზავნა',
	'contact_subject' => 'მესიჯის თემა',
	...
	'email' => 'Email',
	'email_address' => 'ელექტრონული ფოსტის მისამართი',
	...
	'feed' => 'კავშირი',
	'feedback' => 'უკუკავშირის მოწოდება',
	'feedback_reports' => 'დააჭირეთ დაბლა ღილაკს და გაგვიზიარეთ თქვენი გამოცდილება.',
	'feeds' => 'კავშირები',
	...
	'inbox' => 'შემოსული',
	'incident' => 'ინციდენტი',
	'incidents_listed' => 'ინციდენტები <span>(რუქიდან,დალაგებული ქრონოლოგიურად)</span>',
	...
	'location_example' => 'ქალაქი, შტატი და/ან ქვეყანა',
	'login' => 'შესვლა',
	'longitude' => 'გრძედი',
	'map' => 'რუქა',
	...
	'password_reset_prompt' => 'შეიყვანეთ ელექტრონული პოსტა, რომელიც გამოიყენეთ დარეგისტრირების დროს:',
	...
	'pinpoint_location' => '* მოძებნეთ თქვენი მდებარეობა განედის და გრძედის კოორდინატების გამოყენებით (ფორმატი: 38.19,-85.61), ან დააწკაპუნეთ რუქაზე რათა მოინიშნოს სწორი მდებარეობა',
	'play' => 'თამაში',
	...
	'reports_find_location' => 'იპოვე ადგილმდებარეობა თქვენთან ახლოს',
	'reports_first' => 'სახელი',
	'reports_last' => 'გვარი',
	'reports_location_name' => 'ადგილდებარეობის სახელის სრულყოფა',
	'reports_news' => 'სიახლის წყაროს ბმული',
	...
	'reports_submit_new' => 'ახალი ანგარიშის გამოქვეყნება',
	'reports_time' => 'დრო',
	'reports_timeline' => 'ქრონოლოგია',
	'reports_title' => 'ანგარიშის სათაური',
	'reports_video' => 'ვიდეოს ბმული',
	'report_an_incident' => 'შეგვატყობინეთ ინციდენტი',
	'report_details' => 'ანგარიშის დეტალები',
	'report_edit_dropdown_1_default' => '--- აირჩიეთ ერთი ---',
	'report_edit_dropdown_1_item_1' => 'დიახ, წყაროს აქვს პირდაპირი ხელმისაწვდომობა ინფორმაციაზე',
	'report_edit_dropdown_1_item_2' => 'დიახ, წყაროს აქვს ხელმისაწვდომობა ინფორმაციაზე, მაგრამ შეიძლება არასწორი',
	'report_edit_dropdown_1_item_3' => 'დიახ, ამ წყაროს აქვს პირდაპირი ხელმისაწვდომობა ინფორმაციაზე, მაგრამ ხშირად მართალია',
	'report_edit_dropdown_1_item_4' => 'ყოველთვის არა, მაგრამ ხშირად სწორია',
	'report_edit_dropdown_1_item_5' => 'არა, წყაროს არ აქვს (არ ჰქონდა) ინფორმაციაზე ხელმისაწვდომობა',
	'report_edit_dropdown_1_item_6' => 'არ ვიცი',
	'report_edit_dropdown_1_title' => 'წყაროს საიმედოობა',
	'report_edit_dropdown_2_default' => '--- აირჩიეთ ერთი ---',
	'report_edit_dropdown_2_item_1' => 'დიახ, ინფორმაცია გადამოწმებულია რამდენიმე წყაროსთან',
	'report_edit_dropdown_2_item_2' => 'დიახ, ინფორმაცია ჯერ არ არის გადამოწმებული, მაგრამ სავარაუდოდ',
	'report_edit_dropdown_2_item_3' => 'დიახ, ინფორმაცია აზრიანია',
	'report_edit_dropdown_2_item_4' => 'არა, ინფორმაცია გასაკვირია',
	'report_edit_dropdown_2_item_5' => 'არა, ინფორმაცია საეჭვოა და შეიძლება შეიცავდეს დეზინფორმაციას',
	'report_edit_dropdown_2_item_6' => 'არ ვიცი',
	'report_edit_dropdown_2_title' => 'ინფორმაციის ალბათობა',
	'report_option_1' => 'შეტყობინების გაგსავნით',
	'report_option_2' => 'ელექტრონული ფოსტის გაგზავნით ',
	'report_option_3' => 'ჰეშტაგით (#) ტვიტის გაგზავნა',
	...
	'trustworthiness_option_1' => 'დიახ, წყაროს აქვს პირდაპირი ხელმისაწვდომობა ინფორმაციაზე',
	'trustworthiness_option_2' => 'დიახ, წყაროს აქვს ხელმისაწვდომობა ინფორმაციაზე, მაგრამ შეიძლება არასწორი',
	'trustworthiness_option_3' => 'დიახ, ამ წყაროს აქვს პირდაპირი ხელმისაწვდომობა ინფორმაციაზე, მაგრამ ხშირად მართალია',
	'trustworthiness_option_4' => 'ყოველთვის არა, მაგრამ ხშირად სწორია',
	'trustworthiness_option_5' => 'არა, წყაროს არ აქვს (არ ჰქონდა) ინფორმაციაზე ხელმისაწვდომობა',
	'twitter' => 'Twitter',
	'unread' => 'წაუკითხავი',
	...
	'upload_reports_detail_2' => 'ანგარიში უნდა იქნას ატვირთული CSV ფორმატში',
	'upload_reports_detail_3' => 'თუ ინციდენტის ID უკვე არის შეტანილი ბაზაში, CSV ფაილში შესვლა იქნება იგნორირებული',
