<?php
	...
	'checkins' => 'იუზერის ვიზიტები/Checkins',
	'cleanurl' => array(
	...
	'sms' => array(
		...
		'flsms_description' => 'FrontlineSMS არის უფასო პროგრამული უზრუნველყოფის წყარო რომელიც რთავს ლეპტოპსა და მობილურ ტელეფონს ცენტრალური კომუნიკაციის კერაში/hub. ერთხელ დაინსტალირებით, პროგრამა საშუალებას აძლევს მომხმარებლებს გზავნონ და მიიღონ ტექსტური შეტყობინებები დიდი მოცულობის ჯგუფებთან მობილური ტელეფონის საშუალებით. დააწკაპეთ რუხ ყუთს გადმოსაწერად FrontlineSMS.com-დან',
		'flsms_download' => 'გადმოიწერეთ Frontline SMS და დააინსტალეთ თქვენს კომპიუტერზე',
		'flsms_instructions' => 'შეტყობინებები მიღებული FrontlineSMS-ის წყაროდან/კერიდან/hub შესაძლებელი იქნება სინქრონიზირდეს უშაჰიდით.დეტალური ინსტრუქცია როგორ უნდა სინქრონიზირდეს <strong><a href="http://wiki.ushahididev.com/doku.php?id=how_to_use_ushahidi_alpha#how_to_setup_frontlinesms_to_sync_with_ushahidi" target="_blank">here</a></strong>.თქვენ დაგჭირდებათ პაროლი/key და ბმული/link ქვემოდან რომ მოახდინოთ სინქრონიზაციის დაყენებაFrontlineSMS',
		'flsms_key' => 'თქვენი Ushahidi-ის სინქრონიზაციის პაროლი/key',
		'flsms_link' => 'FrontlineSMS HTTP პოსტის ბმული',
		'flsms_synchronize' => 'სინქრონიზაცია უშაჰიდის საშუალებით',
	...
	'ssl' => array(
		'enable_ssl' => 'გააქტიურება SSL',
		'ssl_disabled' => 'უშაჰიდი არის ერთადერთი მისაწვდომი დეფოლტ პროტოკოლზე; "http"',
		'ssl_enabled' => 'ეს პარამეტრი საშუალებას აძლევს უშაჰიდის მისაწვდომი იყოს SSL-ით მაგალითად. "http-ებით" URL-ში',
		'title' => 'SSL Support',
	),
	'timezone' => 'ლოკალური დრო',
	);
?>
