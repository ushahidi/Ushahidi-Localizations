<?php
	...
	'category_impact_description' => 'Тази графика показва промяната на броя сигнали в различните категории през времето. Минете отляво надясно за да видите сравенителен поглед на различните категории. Когато минете с мишката отгоре ще видите повече подробности',
	...
	'stats_not_setup' => 'Статистилата не е настроена',
	...
	'unique_visitors_description' => 'Броя хора, които са посетили сайта. Уникалните посетители се засичат с cookie-а. Когато посетителя не е включил cookie-тата, разпознаването става по IP адрес, резолюция, операцонна система и прочие.',
