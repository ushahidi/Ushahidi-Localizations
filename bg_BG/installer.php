<?php
	...
	'database_host_description' => 'Ако Ushahidi ще върви на вапият компютър, това най-вероятно ще е "localhost". Ако ще върви на сървър, моля попитайте доставчикът си',
	...
	'default_language_description' => 'Всеки пакен на Ushahidi идва с вградени езици по подразбиране. Може <a href="http://wiki.ushahidi.com/doku.php?id=localisation_l10n_internationlisation_i18n&s[]=language#enabling_new_languages" target="_blank">да добавите</a> и други',
	'disable' => 'Изключи',
	'enable' => 'Включи',
