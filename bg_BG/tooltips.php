<?php
	...
	'settings_share_site_stats' => 'Статистиката за посещенията се изпраща на сървър контролиран от Ushahidi. Като включите тази опция, вие получавате достъп до тази информация от административният си панел. Като я изключите, вие ще спрете да събирате и имате достъп ди статистика за периода.',
