<?php
	...
	'email' => 'Email',
	'error_geocoding' => 'Грешка в грографските координати! HTTP грешка',
	...
	'feeds' => 'абонаменти',
	'field_default' => 'Строност по подразбиране',
	...
	'invalid_parameter' => 'Невалиден параментър',
	'ip_address' => 'IP адрес',
	...
	'multiple_hosted_instances' => 'Множесто инсталации',
	...
	'page_not_found_message' => 'Съжалявам, но страницата, която се опитвате да отворите, не е тук. <p><strong>Отворихте ли линк, за да стигнете до тук?</strong><br />Ако сте отворили страницата от друга част на сайта, моля <a href="#">свържете се с нас</a>, за да оправим грешката си.</p><p><strong>Отворихте ли линк ор друг сайт? </strong><br />Линковете идващи от други сайтове понякога са стари или грешни. <a href="#">Кажете ни</a> откъде сте отворили тази страница и ще се опитаме да се свържем с тях да оправят проблема.</p><p><strong>Написахте ли адреса? </strong><br />Възможно е да сте го написали грешно. Проверете отново дали всичко е вярно. </p>',
	...
	'stats' => 'Статистика',
	'stats_collection_error' => 'Събирането на статистика се провали! Или сървъра за статитика не работи, или има проблем в инсталацията на Ushahidi. Опитайте пак, за да проверите дали сървъра работи. За да възстановите ръчно статистиката, променете stat_id (на null) и stat_key (на 0) в таблицата за настройки в базата данни. ВНИМАНИЕ: Ще загубите достъп до статистиката си, ако направите това !',
