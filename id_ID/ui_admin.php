...
// PO revision date:  2013-10-28 01:07+0000
$lang = array(
	'access_denied_credentials' => 'Akses ditolak.',
	...
	'error_geocoding' => 'Galat dalam geocoding! Galat HTTP',
	'error_imap' => 'Library IMAP PHP belum terpasang',
	'error_twitter' => 'Kredensial Tidak Tepat',
	'error_msg' => 'Galat!',
	'error_post_incident' => 'Galat, tidak bisa melaporkan kejadian',
	...
	'from' => 'Dari',
	'from_date' => 'Dari',
	'geonames_timeout' => 'Galat Waktu Habis untuk Penamaan Lokasi',
	...
	'multiple_hosted_instances' => 'Beberapa Contoh ',
	...
	'page_not_found_message_with_contact' => 'Maaf, halaman yang And a inginkan tidal ada di sini.<p><strong>Apakah Anda mengikuti tauten dari sebuah alamat di situs Anda?</strong><br /> Jika Anda menemukan halaman ini dari bagian lain dal am situs ini, moon <a href="%s">hubungi kami</a> agar kami bias memperbaikinya.</p><p><strong>Atau, apakah Anda menemukan tautan dari situs lain? </strong><br />Tautan dari situs lain bias saga terjadi kesalahan ejaan. <a href="%s">Beritahu kami</a> darimana Anda mengakses halaman ini, sehingga kami bisa mengirimkan situs tersebut ralat.</p><p><strong>Atau, apakah Anda mengetik sendiri alamat tautan ini?</strong><br />Tautan  (URL) mungkin salah. Periksa lagi ejaan dan tulisan yang tepat. </p>',
	...
	'password_reset_message_line_3' => 'Untuk mengubah kata sandi, klik tautan di bawah ini (atau salin dan tempen di perambah Anda).',
	...
	'please_select' => 'Pilih ',
	'pm' => 'PM',
	'post_method_not_used' => 'Data tidak bisa dikirim dengan cara pengiriman',
	'preview' => 'Pratinjau',
	...
	'select_field_type' => '-- Pilih Satu Jenis Berkas --',
	...
	'special_category_explanation' => 'Ini adalah kategori khusus yang tidak ditampilkan di formulir pelaporan. Ini hanya digunakan untuk fitur "Palpor Terpercaya".',
	...
	'delete_all_instructions' => 'Klik tombol di bawah ini akan menghapus SEMUA laporan dalam database. Anda harus melakukan dengan penuh perhitungan karena data tidak bisa dikembalikan lagi.',
