...
// PO revision date:  2014-02-21 11:25+0000
$lang = array(
	...
	'allow_feed_category' => array(
		'between' => 'Kolom isian kategori feed tidak benar.',
		'required' => 'Kolom isian kategori feed harus diisi.',
	) ,
	'allow_alerts' => array(
		'between' => 'Isian peringatan tidak akan ditampilkan apabila tidak diisi dengan benar.',
		'required' => 'Isian peringatan harus diisi.',
	) ,
	'allow_reports' => array(
		'between' => 'Isian laporan yang diijinkan tidak akan ditampilkan apabila tidak diisi dengan benar.',
		'required' => 'Isian laporan yang diijinkan harus diisi.',
	) ,
	'allow_stat_sharing' => array(
		'between' => 'Isian stat berbagi tidak akan ditampilkan apabila tidak diisi dengan benar.',
		'required' => 'Isian status berbagi harus diisi.',
	) ,
	'api' => array(
	...
	'cleanurl' => array(
		'clean_url_disabled' => 'Sepertinya server Anda tidak diatur supaya bias mengatasi clean URL. Anda perlu mengubah konfigurasi server sebelum memperbolehkan penggunaan clean URL. Lihat lebih lanjut mengenai clean URL di <a href="http://forums.ushahidi.com/topic/server-configuration-for-apache-mod-rewrite" target="_blank">forum diskusi ini</a>',
	...
	'clickatell_password' => array(
		'length' => 'Kolom kata sandi CLiackatell setidaknya terdiri atas 5 dan tidak ;ebih dari 50 karakter.',
	...
	'email_username' => array(
		'length' => 'Nama pengguna dal am mail server tidak bole lebih dari 50 karakter.',
	...
	'facebook' => array(
		...
		'description_2' => 'Pengaturan ini memungkinkan pengguna untuk masuk melalui Facebook, tapi <strong>bukan</strong> mengembangkan aplikasi Facebook di situs Anda.',
		'app_id' => 'ID Aplikasi Facebook',
		'app_secret' => 'Kode Rahasia Aplikasi Facebook',
	) ,
	'google_analytics' => array(
		'length' => 'Kolom Google Analytics harus mengandung Web Property ID dalam format UA-XXXXX-XX.',
	) ,
	'https' => array(
		'enable_https' => 'HTTPS Diijinkan',
		'https_disabled' => 'Opsi ini memungkinkan Ushahidi bisa diakses dalam moda tidak aman; <strong>tanpa</strong> "https://" dalam awalan tautan',
		'https_enabled' => 'Opsi ini memungkinkan Ushahidi bisa diakses dalam moda aman; dengan awalan <strong>https</strong> di tautan',
		'title' => 'HTTPS',
	) ,
	'items_per_page' => array(
		'between' => 'Isian dalam kolom jumlah item per halaman (Halaman Depan) tidak benar.',
		'required' => 'Isian dalam kolom jumlah item per halaman (Halaman Admin) tidak benar.',
	) ,
	...
	'site' => array(
		...
		'allow_feed_category' => 'Membuat Kategori Baru danri Feeds',
		...
		'kismet_notice' => 'Cegah komentar berupa spam dengan menggunakan <a href="http://akismet.com/" target="_blank">Akismet</a> dari Automattic. <BR />Anda bias memperoleh kunci API secara gratis dengan mendaftarkan diri di <a href="http://en.wordpress.com/api-keys/" target="_blank">WordPress.com</a>',
		...
		'name' => 'Nama SItus',
		'private_deployment' => 'Pengembangan untuk Pribadi',
	...
	'sms' => array(
		...
		'flsms_instructions' => 'Intruksi terperinci cara mengirim SMS melalui FrontlineSMS sudah tersedia <strong><a href="https://wiki.ushahidi.com/pages/viewpage.action?pageId=5670692" target="_blank">di sini</a></strong>. Tautan dan kunci API di bawah ini diminta untuk pengaturan dan sinkronisasi data dengan FrontlineSMS.',
		...
		'flsms_synchronize' => 'Menghubungkan antara FrontlineSMS dengan Ushahidi',
	...
	'twitter' => array(
		...
		'description' => 'Untuk memperoleh informasi di bawah ini, silahkan bikin dahulu sebuah aplikasi Twitter baru di',
