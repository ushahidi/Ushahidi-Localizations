...
// PO revision date:  2013-03-08 07:45+0000
$lang = array(
	...
	'banner_image' => array(
		'default' => 'در حین بارگذاری تصویر برنمای شما مشکلی پیش آمد.',
		'size' => 'سایز برنمای شما از حداکثر سایز مجاز برای این باگذاری بیشتر است.',
	) ,
	'cache_pages' => array(
	...
	'sms' => array(
		...
		'flsms_description' => 'FrontlineSMS یک نرم افزار مجانی منبع باز می باشد که می تواند لپ تاپ و تلفن همراه شما را به یک قطاب رتباط مرکزی تبدیل کند. بعد از نصب، برنامه توانایی ارسال و دریافت پیام با تلفن همراه به تعداد زیادی از افراد دیگر را به کاربر می دهد. روی جعبه ی خاکستری کلیک کنید تا یک درخواست دانلود به FrontlineSMS.com بفرستید. ',
		'flsms_download' => 'Frontline SMS را دریافت کرده و بر کامپیوتر خود نصب کنید.',
		'flsms_instructions' => 'پیام های دریافتی در هاب FrontlineSMS  می توانند با یوشهیدی همگام شوند.  دستورالعمل های  چگونگی همگام رسانی  را می توانید با جزئیات  <strong><a href="http://wiki.ushahidi.com/display/WIKI/How+to+Set-up+FrontlineSMS+and+Ushahidi" target="_blank"> اینجا  </a></strong> پیدا کنید. شما به کلید و لینک زیر برای به همگام رسانی FrontlineSMS احتیاج دارید.',
		'flsms_key' => 'کلید همگام رسانی یوشهیدی شما',
		'flsms_link' => 'لینک پست FrontlineSMS HTTP ',
		'flsms_synchronize' => 'همگام رسانی با یوشهیدی',
