<?php
    ...
    'upgrade_title_text_1' => '您当前应用的版本是 Ushahidi v',
    'upgrade_title_text_2' => '数据库版本是 ',
	'upgrade_title_text_3' => '上运行的',
	'upgrading' => '正在升级',
    ...
    'upgrade_warning_software_version' => '警告：version.php和数据库软件版本不匹配。',
    'upgrade_warning_db_version' => '警告：在version.php数据库版本与数据库不匹配。',
