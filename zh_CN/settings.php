<?php
	...
	'facebook' => array(
		'title' => 'Facebook 安装选项',
		'description' => '要获取信息，您将需要创建一个新的Facebook的应用',
	...
	'https' => array(
	   ...
	   'https_disabled' => '该选项使Ushahidi以不安全的模式访问；<strong>不包括</strong> "https://" URL前缀',
	   'https_enabled' => '该选项使Ushahidi以安全的模式访问；<strong>包括</strong> "https://" URL前缀',
	   'title' => 'HTTPS'
	),
	...
	'sms' => array(
		...
		'flsms_instructions' => '消息接收到Front lineSMS集线器可以与同步Ushahidi。详细说明如何同步可以到<strong><a href="http://wiki.ushahidi.com/display/WIKI/How+to+Set-up+FrontlineSMS+and+Ushahidi" target="_blank">这里</a></strong>. 你将需要重点和下面的链接建立同步Front lineSMS',
