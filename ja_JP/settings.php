...
',
		...
		'flsms_instructions' => 'FrontlineSMSを使ってメッセージ受信する事でUshahidiと同期を取る事が出来ます。<strong><a href="http://wiki.ushahididev.com/doku.php?id=how_to_use_ushahidi_alpha#how_to_setup_frontlinesms_to_sync_with_ushahidi" target="_blank">こちら</a></strong>に設定方法が記載されています。FrontlineSMSと同期を取る為の設定とキー取得方法が記載されています。',
		'flsms_key' => 'Ushahidi同期キー',
		'flsms_link' => 'FrontlineSMS HTTP投稿リンク',
		'flsms_synchronize' => 'Ushahidiと同期する',
