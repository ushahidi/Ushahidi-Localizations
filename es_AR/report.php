<?php
	...
	'country_name' => array(
		'single_country' => 'La ubicación del reporte debe estar dentro del país seleccionado en la configuración del sistema'.ORM::factory('country', Kohana::config('settings.default_country'))->country.'.'
	),
	'custom_field' => array(
