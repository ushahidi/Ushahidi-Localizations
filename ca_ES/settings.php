...
// PO revision date:  2012-08-20 11:29+0000
$lang = array(
	...
	'banner_image' => array(
		'default' => 'Alguna cosa ha fallat punjant la imatge del banner.',
		'size' => 'La mida del banner excedeix el límit per aquesta pujada.',
	) ,
	'cache_pages' => array(
	...
	'sms' => array(
		...
		'flsms_description' => 'FrontlineSMS és un software de codi obert i gratuït que converteix un portàtil i un telèfon mòbil en un centre de telecomunicacions. Un cop instal·lat, el programa permet als usuaris enviar i rebre missatges de text amb amplis grups d`usuaris a través dels telèfons mòbils. Cliqueu al botó gris per descarregar-lo de FrontlineSMS.com',
		'flsms_download' => 'Descarregueu Frontline SMS i instal.leu-lo al vostre ordinador',
		'flsms_instructions' => 'Els missatges rebuts en un centre FrontlineSMS poden sincroniutzar-se amb l`Ushahidi. Les instruccions detallades per sincronitzar es troben a <strong><a href="http://wiki.ushahididev.com/doku.php?id=how_to_use_ushahidi_alpha#how_to_setup_frontlinesms_to_sync_with_ushahidi" target="_blank">aquí (en anglès)</a></strong>. La clau i la URL que s`indiquen a continuació seran necessàries per establir la sincronització amb el FrontlineSMS',
		'flsms_key' => 'Clau de Sincronització Ushahidi',
		'flsms_link' => 'Enllaç HTTP POST per a FrontlineSMS',
		'flsms_synchronize' => 'Sincronitzar amb l`Ushahidi',
