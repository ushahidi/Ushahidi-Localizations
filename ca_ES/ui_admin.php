<?php
	...
	'openids' => 'OpenID\'s',
	'orphaned_category_explanation'=>'Aquesta és una categoria especial que no es mostrarà al formulari per reportar informació pels usuaris que reportin. Es fa servir per a mantenir els informes que no tenen categories (informes orfes) com a resultat de l`esborrat d`una categoria',
	'page' => 'pàgina',
	'pages' => 'pàgines',
	'page_not_found' => 'Pàgina No Trobada',
	'page_not_found_message' => 'Perdoneu, la pàgina que intenteu veure no està aquí.<p><strong>Heu arribat aquí seguint un enllaç d`un altre lloc d`aquest site?</strong><br />Si heu arribar a aquesta pàgina des d`una altra part del nostre site, si us plau <a href="#">contacteu-nos</a> per a procedir a corregir aquesta errada.</p><p><strong>Heu seguit un enllaç des d`un altre site? </strong><br />Els enllaços des d`altres sites poden estar desactualitzats o mal escrits. <a href="#">Digueu-nos</a> d`on venieu i mirarem de contactar amb l`altre site per arreglar el problema.</p><p><strong>Heu escrit vosaltres mateixos la URL? </strong><br />Potser heu escrit l`adreça (URL) incorrectament. Reviseu-ho per estar segurs que ho heu escrit correctament. </p>',
...
Aquesta és una categoria especial que no es mostrarà al formulari per reportar informació pels usuaris que reportin. Es fa servir conjuntament amb la característica "Reportadors de Confiança".',
