<?php
	...
	'actions' => array(
		...
		'send_to' => 'Выбрав "Triggering User" электроное письмо будет отослано пользователю выполнившему действие. При использовании радио-кнопки после поля ввода вы сможете ввести любой другой e-mail. Это полезно, когда вы устанавливаете триггеры для уведомления пользователей о произошедших изменениях.',
	...
	'profile_color' => 'Вы можете выбрать цвет, который будет отображён под вашим аватаром. Этим цветом также будут отображаться Точки, которые вы отправили..',
	...
	'settings_server_username' => 'E-mail, на который будут приходить Точки',
