<?php
	...
	'private_to' => 'Начните печатать, что бы выпал список пользователей',
	'private_subject' => 'Тема личного сообщения',
	'private_message' => 'Личное сообщение',
	'profile_color' => 'Вы можете выбрать цвет, который будет отображён под вашим аватаром. Этим цветом так же, будет отображаться Точки которые вы отправили..',	
	...
	'settings_banner' => 'Заставка показывается наверху вашего сайта, если тема её поддерживает. Оптимальный размер зависит от используемой темы. Обратите внимание, что заставка заменит собой название и лозунг сайта.',
	...
	'settings_site_submit_report_message' => 'Сообщение которое будет показываться пользователям на странице заполнения данных о новой Точке. Возможно использование для информирования о юридической ответственности или других инструкциях.',
