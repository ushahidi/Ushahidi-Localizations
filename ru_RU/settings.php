<?php
	...
	'email_host' => array(
		...
		'required' => 'Заполните поле "Адрес почтового сервера"',
	),
	...
	'sms' => array(
		...
		'flsms_description' => 'FrontlineSMS — бесплатная программа, которая позволяет превратить ноутбук или мобильный телефон в центр управления. Установленная программа позволяет пользователям отправлять и получать SMS для большой группы через мобильные телефоны. Нажмите на кнопку для установки с FrontlineSMS.com',
		...
		'flsms_key' => 'Ващ ключ синхронизации Ushahidi',
