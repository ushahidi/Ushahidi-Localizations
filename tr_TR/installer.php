...
$lang = array (
  ...
  'files_location_text' => 'Bu konum Ushahidi dosyalarının bulunduğu yerdir. <strong>Biz bu konumu otomatik olarak tespit ettik, lütfen bu konumun doğru olduğundan emin olun.</strong>Eğer bu alan boş ise, endişelenmeyin, Ushahidi en üst seviyedeki yere kurulmuştur.(WWW)',
  'finished' => 'Tamamlandı',
  'general' => 'Genel',
  ...
  'mail_server_password' => 'Posta Sunucu Şifresi',
  'mail_server_password_description' => 'E-posta hesabınıza girerken kullandığınız şifre',
  ...
  'mail_server_username' => 'Posta Sunucu Hesabı',
  'mail_server_username_description' => 'Gmail, Hotmail veya Yahoo Mail kullanıyorsanız, hesap adınızı tüm e-posta adresi olarak girin.',
  'map' => 'Harita',
  'map_provider' => 'Harita Sağlayıcı',
  'map_provider_description' => 'Ushahidi bu sağlayıcılarla neredeyse eşit olarak çalışır: Google, Bing, Yahoo veya Open Street Map. Bulunduğunuz yeri en detaylı olarak gösteren sağlayıcıyı seçmenizde fayda var',
