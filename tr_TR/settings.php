<?php
            ...
            'clickatell_password' => 'Clickatell Şifreniz',
            ...
            'flsms_description' => 'FrontlineSMS (ücretsiz servis) dizüstü bilgisayarınızı ve cep telefonunuzu genel iletişim ağına çevirir. Yüklendiğinde, yazılım, kullanıcıların büyük gruplara sms göndermelerine veya (gruplardan) almalarına izin verir. Yazılımı yüklemek istiyorsanız lütfen gri kutucuğu işaretleyin.',
            'flsms_download' => 'Frontline SMS uygulamasını indir ve yükle',
            'flsms_instructions' => 'Frontline SMS adlı uygulamaya gelen mesajlar Ushahidi ile eşleştirilebilir. "Nasıl eşleştirebilirim?" diyorsanız <strong><a href="http://wiki.ushahididev.com/doku.php?id=how_to_use_ushahidi_alpha#how_to_setup_frontlinesms_to_sync_with_ushahidi" target="_blank">buraya tıklayın (ingilizce)</a></strong>. Frontline SMS adlı uygulamayı eşleştirmek için anahtara gerek duyacaksınız',
            'flsms_key' => 'Ushahidi Eşleştirme Anahtarınız',
            'flsms_link' => 'FrontlineSMS HTTP Gönder BAĞLANTISI',
            'flsms_synchronize' => 'Ushahidi ile eşleştirildi',
